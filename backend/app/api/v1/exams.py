...
def _build_answer_sheets_response(
    ...
    if autofit:
        # Recalcula caixa/espaçamento para encher cada página com 10–12 questões.
        sheet_options = autofit_practical_options(slots, sheet_options or {}, has_logo=logo_bytes is not None)
    try:
